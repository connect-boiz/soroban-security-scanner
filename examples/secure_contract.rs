...
impl SecureToken {
    ...
    pub fn mint(env: Env, to: Address, amount: i128) {
        ...
        env.storage()
            .persistent()
            .set(&Symbol::new(&env, "total_supply"), &total_supply);
        ...
        // SECURE: Emit event
        env.events()
            .publish((Symbol::new(&env, "mint"), to), (amount, total_supply));
    }
    ...
    pub fn burn(env: Env, from: Address, amount: i128) {
        ...
        // SECURE: Emit event
        env.events()
            .publish((Symbol::new(&env, "burn"), from), (amount, total_supply));
    }
    ...
    pub fn admin_only_function(env: Env, admin: Address, data: Symbol) {
        ...
        env.events()
            .publish(Symbol::new(&env, "admin_action"), (admin, data));
    }
    ...
    pub fn withdraw(env: Env, amount: i128) {
        ...
        env.events()
            .publish((Symbol::new(&env, "withdraw"), caller), amount);
    }
