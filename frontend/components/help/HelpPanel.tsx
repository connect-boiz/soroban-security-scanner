      ...
      >
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="space-y-6">
            <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest">In-Depth Concepts</h3>
            <div className="grid grid-cols-1 gap-4">
              {Object.entries(content).map(([key, value]) => {
                if (key === 'title' || key === 'description') return null;
                return (
                  <div key={key} className="bg-gray-50 p-5 rounded-2xl border border-gray-100 hover:border-blue-200 hover:bg-blue-50/30 transition-all duration-200">
