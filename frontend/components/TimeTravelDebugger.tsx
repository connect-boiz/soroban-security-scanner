  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
      ...
      <div className="space-y-4">
        <div>
          <label
            htmlFor="ledger-sequence"
            className="flex items-center gap-1 text-sm font-medium text-gray-700 mb-2"
          >
            Ledger Sequence
            <HelpIcon
              content={HELP_CONTENT.timeTravelDebugger.ledgerSequence}
        ...
        <div className="p-4 bg-gray-50 rounded-lg border border-gray-200">
          <div className="flex items-center justify-between mb-4">
            ...
            <HelpIcon
              content={HELP_CONTENT.timeTravelDebugger.contractUpgrade}
        ...
        <button className="btn btn-primary w-full">Fork Network State</button>
      </div>
    </div>
  );
};
