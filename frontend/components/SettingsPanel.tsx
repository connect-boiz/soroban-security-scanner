      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        {(isSaving || saveProgress > 0) && (
          <div className="mb-6 bg-blue-50 rounded-lg p-4 border border-blue-200">
            ...
            <ProgressBar value={saveProgress} color="blue" showLabel={false} className="w-full" />
          </div>
        )}
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={e =>
                          setUserPreferences({
                            ...userPreferences,
                            displayMode: e.target.value as 'compact' | 'detailed',
                          })
                        }
                        className="input"
                      >
                  ...
                  <div className="space-y-3">
                    ...
                    <label className="flex items-center space-x-3">
                      <input
                        ...
                        onChange={e =>
                          setUserPreferences({ ...userPreferences, autoSave: e.target.checked })
                        }
                        className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                      />
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={e =>
                      setSecuritySettings({
                        ...securitySettings,
                        scanSensitivity: e.target.value as 'low' | 'medium' | 'high',
                      })
                    }
                    className="input"
                  >
              ...
              <div className="space-y-3">
                <label className="flex items-center space-x-3">
                  <input
                    ...
                    onChange={e =>
                      setSecuritySettings({ ...securitySettings, autoScan: e.target.checked })
                    }
                    className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                  />
              ...
              <div className="space-y-3">
                <label className="flex items-center space-x-3">
                  <input
                    ...
                    onChange={e =>
                      setThemeSettings({ ...themeSettings, highContrast: e.target.checked })
                    }
                    className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                  />
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-50 p-4 rounded-md">
                <p className="text-sm text-gray-600">
                  ...
                  {new Date(accountSettings.lastLogin).toLocaleString()}
                </p>
              </div>
              ...
              <div className="space-y-3">
                <label className="flex items-center space-x-3">
                  <input
                    ...
                    onChange={e =>
                      setAccountSettings({ ...accountSettings, exportData: e.target.checked })
                    }
                    className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                  />
