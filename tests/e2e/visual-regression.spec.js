...
test.describe('Visual Regression Tests', () => {
  test.skip('home page matches snapshot', async ({ page }) => {
    await page.goto('/');
  ...
  test.skip('scan results page matches snapshot', async ({ page }) => {
  ...
  test.skip('vulnerability report card matches snapshot', async ({ page }) => {
    await page.goto('/results');
